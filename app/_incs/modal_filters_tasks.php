<div class="modal fade" id="modal_filters_tasks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" onclick="javascript:$('#modal_filters_tasks').modal('hide')" data-dismiss="modal">Fechar</button>
