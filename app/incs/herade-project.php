<div style="margin-left: 10px;" class="btn-group">
    ...
    <li><a class="dropdown-item text-light" onclick="javascript:$('#exampleModalXlLabel').html('Gestão de Anexos'); $('#iframesc').attr('src', '../painel-base/grid_files_all/?id_companies=1&id_users=1&id_projects=<?=$_GET['i']?>&id_tasks=<?=$r['id_tasks']?>');  $('#modal_sc').modal('show')"><i class="icofont-paper-clip me-2 fs-6"></i>Anexos</a></li>
    ...
    ?>
        <li><a class="dropdown-item text-light" href="dashboard_all.php?i=<?=$_GET['i']?>"><i class="icofont-chart-arrows-axis me-2 fs-6"></i>Indicadores</a></li>
    <?php 
        }
    ?>
