            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="emp-admin">
                        ...
                        ?>
                        <li><a class="m-link" href="conteudos.php?p=grid_project_types&n=Tipos de Projetos"><i class="icofont-island-alt fs-5"></i><span>Tipos de Projetos</span></a></li>                      
                        <li><a class="m-link" href="conteudos.php?p=grid_project_status&n=Status do Projetos"><i class="icofont-island-alt fs-5"></i><span>Status do Projetos</span></a></li>
                        <li><a class="m-link" href="conteudos.php?p=grid_task_status&n=Status de Tarefas"><i class="icofont-island-alt fs-5"></i><span>Status de Tarefas</span></a></li>                                         
                    </ul>
                        
                    </li>
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#emp-check" href="#"><i
                            class="icofont-stopwatch fs-5"></i> <span>Checklist</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="emp-check">
                        <li><a class="m-link" href="conteudos.php?p=form_check_list&n=Checklist" ><i class="icofont-speed-meter fs-5"></i><span>Checklist</span></a></li>
                    </ul>
                </li>
