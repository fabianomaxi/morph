                            ...
                            <?php 
                                                        ...
                                                        <li class="py-2 mb-1 border-bottom">
                                                            <a href="javascript:void(0);" class="d-flex">
                                                                ...
                                                                <div class="flex-fill ms-2">
                                                                    ...
                                                                    <span class=""><?=$r['data']?><span class="badge bg-success"><?=$r['history']?></span></span>
                                                                </div>
                                                            </a>
                                                        </li>
                                ...
                                <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                                    <div class="u-info me-2">
                                        <p class="mb-0 text-end line-height-sm"><span class="font-weight-bold"><?=$_SESSION['name_session']?></span></p>
                                            ...
                                            <div class="card-body pb-0">
                                                <div class="d-flex py-1">
                                                    ...
                                                    <div class="flex-fill ms-3">
                                                        <p class="mb-0"><span class="font-weight-bold"><?=$_SESSION['name_session']?></span></p>
                                                        <small class=""><?=$_SESSION['email_session']?></small>
                                                    </div>
                                                </div>
