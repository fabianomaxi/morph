                                        ...
                                        <table id="myProjectTable" class="table table-hover align-middle mb-0 text-center" style="width: 158%;">
                                            ...
                                            if( $c->linhas() > 0 ) { while(!$c->eof()) { $r = $c->fetch() ; ?>
                                                <tr style="cursor: cell; font-weight: bold;">
                                                    ...
                                                    <td class="dt-body-right"><span onclick="javascript:showSubs()" style="cursor:pointer" class="badge bt-subt">5 Subtarefas</span></td>
                                                    ...
                                                    if( $c2->linhas() > 0 ){ while(!$c2->eof()) { $r2 = $c2->fetch() ; ?>
                                                                <li>
                                                                    <a onclick="javascript:changeData('1')" class="dropdown-item py-2 rounded" href="#"><?=$r2['title']?></a>
                                                                </li>
                                                                <?php 
                                                        }
                                                    }
                                                ?>
                                                    ...
                                                    if( $c3->linhas() > 0 ){ while(!$c3->eof()) { $r3 = $c3->fetch() ; ?>
                                                            <li>
                                                                <a onclick="javascript:changeData('','2')" class="dropdown-item py-2 rounded" href="#"><?=$r3['name']?></a>
                                                            </li>
                                                            <?php
                                                        }
                                                    }
                                                ?>
                                                    ...
                                                    <td class="dt-body-right"><span class="badge bg-info">Aguardando</span></td>

                                                    <td class="dt-body-right"><span class="badge bg-info">Aguardando</span></td>

                                                    <td class="dt-body-right"><span class="badge bg-danger">Alta</span></td>

                                                    <td><i class="icofont-check-circled text-success"></i> 10hs</td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu border-0 shadow p-3">
                                                                <li>
                                                                    <a
                                                                        onclick="javascript:$('#exampleModalXlLabel').html('Editar Tarefa'); $('#iframesc').attr('src', '../painel-base/form_tasks/?id_companies=1&id_users=1&id_project=<?=$_GET['i']?>&id_tasks=<?=$r['id_tasks']?>');  $('#modal_sc').modal('show')"
                                                                ...
                                                                <li><a onclick="javascript:$('#riscos').modal('show')" class="dropdown-item py-2 rounded" href="#">Inserir/Consultar Riscos</a></li>
                                                                <li><a onclick="javascript:$('#modal_obs').modal('show')" class="dropdown-item py-2 rounded" href="#">Inserir/Consultar Observações</a></li>
                                                                <li><a onclick="javascript:$('#modal_obs').modal('show')" class="dropdown-item py-2 rounded" href="#">Inserir/Consultar Anexos</a></li>
                                                                <li><a onclick="javascript:$('#modal_obs').modal('show')" class="dropdown-item py-2 rounded" href="#">Inserir/Consultar Lição Aprendida</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <!-- subtarefas -->
                                                <tr style="cursor: cell; display:none" id="subtasks">
                                                    <input type="hidden" name="position_task[]" id="position_task" value="<?=$r['id_tasks']?>" />

                                                    <td><?=$position?>.1</td>
                                                    <td style="text-align: left;"><?=$r['title']?></td>

                                                    <td class="dt-body-right"><span style="cursor:pointer" class="badge bg-primary">5 Subtarefas</span></td>
